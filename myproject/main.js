...
async function addProduct(e) {
  ...
  const promise = await axios.post(
    "https://crudcrud.com/api/3ce9b9ec4a1b40a0a19a7364de50ef60/StockData",
    stockObject
  );
...
async function buyOne(id) {
  ...
  if (td.innerText > 0) {
   ...
   let result = await axios.get(
        `https://crudcrud.com/api/3ce9b9ec4a1b40a0a19a7364de50ef60/StockData/${id}`
      )
      console.log('hhhhh')
      // .then((res) => {
...
let response = await axios.get("hhttps://crudcrud.com/api/3ce9b9ec4a1b40a0a19a7364de50ef60/StockData")
    // .then((response) => {
